...
function Home() {
    return (React.createElement(React.Fragment, null,
        React.createElement("div", { className: "h-screen  w-full rounded-md flex md:items-center md:justify-center dark:bg-black/[0.96] bg-white antialiased dark:bg-grid-white/[0.02] bg-grid-black/[0.2] relative overflow-hidden" },
            React.createElement(Spotlight_1.Spotlight, { className: "-top-40 left-0 md:left-60 md:-top-20", fill: "white" }),
        ...
        React.createElement("section", { className: "flex justify-center items-center flex-col md:!mt-20 mt-[40px]" },
            ...
            React.createElement("div", { className: "flex  justify-center gap-4 flex-wrap mt-6" }, constants_1.pricingCards.map(function (card) { return (
