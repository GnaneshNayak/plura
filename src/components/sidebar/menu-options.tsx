...
const MenuOptions = ({
  ...
  return (
    <Sheet
      ...
      {...openState}
    >
      <SheetTrigger className="absolute top-4 left-4 z-[100] md:!hidden flex">
      ...
      <SheetContent
        ...
        side={'left'}
        className={clsx(
          'bg-background/80 backdrop-blur-xl border-r-[1px] fixed top-0 p-6',
          {
        ...
        <div>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <Button
                className="w-full flex justify-between items-center my-4 py-8"
                variant={'ghost'}
              >
            ...
            <PopoverContent className="w-80 h-80 z-[200] mt-4">
