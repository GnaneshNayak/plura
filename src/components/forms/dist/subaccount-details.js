...
var loading_page_1 = require("../global/loading-page");
        ...
        React.createElement(card_1.CardContent, null,
            React.createElement(form_1.Form, __assign({}, form),
                React.createElement("form", { onSubmit: form.handleSubmit(onSubmit), className: "space-y-4" },
                    ...
                    React.createElement(button_1.Button, { type: "submit", disabled: isLoading }, isLoading ? React.createElement(loading_page_1["default"], null) : 'Save Account Information'))))));
};
